...
| Sprint 2 | 2026-06-18 | [b2-sprint2-bench-v2.md](b2-sprint2-bench-v2.md) | **Evaluación cuantitativa BENCH v2.** 5 modelos × 2 splits (196 imgs). GDINO-tiny mejor mAP (0.441). GDINO-base mejor vest y CR-01. MM-GDINO-tiny descartado (bboxes degeneradas). YOLOE-26l rápido pero bare_head=0. |
...
### Sprint 1 — dataset_v1 (37 imgs MOCS curadas)
...
### Sprint 2 — BENCH v2 (196 imgs construction_site_safety val+test)

Configs en `configs/runs/experiments/bench_v2/`. Prompt set: `cr01_cr02_bench_v2` (`person/helmet/vest/bare_head`).  
Evaluación: `python3 datasets/scripts/bench/evaluate_bench.py` (en `e-ovrt_datasets`). Ver ficha: [b2-sprint2-bench-v2.md](b2-sprint2-bench-v2.md).

| ID | Fecha | Config | Modelo | Split | Run ID | Veredicto |
|----|-------|--------|--------|-------|--------|-----------|
| B2-G-E1-TEST | 2026-06-18 | bench_v2/b2_g_e1_gdino_t_test.yaml | GDINO-tiny / cuda | test (82) | run_20260618_033948_b2_g_e1_gdino_t_test | mAP=0.245 (test). Candidato principal: mejor mAP global combinado 0.441, helmet AP=0.794. |
| B2-G-E1-VAL | 2026-06-18 | bench_v2/b2_g_e1_gdino_t_val.yaml | GDINO-tiny / cuda | val (114) | run_20260618_034055_b2_g_e1_gdino_t_val | mAP=0.216 (val). Ver combinado en B2-G-E1-TEST. |
| B2-G-E2-TEST | 2026-06-18 | bench_v2/b2_g_e2_gdino_b_test.yaml | GDINO-base / cuda | test (82) | run_20260618_033315_b2_g_e2_gdino_b_test | mAP=0.240 (test). Mejor vest (AP=0.439) y CR-01 recall (0.523) combinado. |
| B2-G-E2-VAL | 2026-06-18 | bench_v2/b2_g_e2_gdino_b_val.yaml | GDINO-base / cuda | val (114) | run_20260618_033802_b2_g_e2_gdino_b_val | mAP=0.207 (val). Ver combinado en B2-G-E2-TEST. |
| B2-G-E5-TEST | 2026-06-18 | bench_v2/b2_g_e5_mmgdino_t_test.yaml | MM-GDINO-tiny / cuda | test (82) | run_20260618_034158_b2_g_e5_mmgdino_t_test | **DESCARTADO. Bboxes degeneradas** (width≈0). Bug en adaptador. mAP=0.007 (no representativo). |
| B2-G-E5-VAL | 2026-06-18 | bench_v2/b2_g_e5_mmgdino_t_val.yaml | MM-GDINO-tiny / cuda | val (114) | run_20260618_034253_b2_g_e5_mmgdino_t_val | **DESCARTADO** (mismo bug que B2-G-E5-TEST). |
| B2-G-E6-TEST | 2026-06-18 | bench_v2/b2_g_e6_mmgdino_b_test.yaml | MM-GDINO-base / cuda | test (82) | run_20260618_034348_b2_g_e6_mmgdino_b_test | mAP=0.194 (test). Bboxes válidas. Combinado 0.337 — por debajo de GDINO-base. Sin ventaja. |
| B2-G-E6-VAL | 2026-06-18 | bench_v2/b2_g_e6_mmgdino_b_val.yaml | MM-GDINO-base / cuda | val (114) | run_20260618_034454_b2_g_e6_mmgdino_b_val | mAP=0.187 (val). Ver combinado en B2-G-E6-TEST. |
| B2-Y-E3-TEST | 2026-06-18 | bench_v2/b2_y_e3_yoloe_26l_test.yaml | YOLOE-26l @ 640 / cuda | test (82) | run_20260618_034606_b2_y_e3_yoloe_26l_test | mAP=0.226 (test). **9 FPS, 318 MB VRAM**. Vest≈0, bare_head=0. Candidato sólo para CR-01 sin vest. |
| B2-Y-E3-VAL | 2026-06-18 | bench_v2/b2_y_e3_yoloe_26l_val.yaml | YOLOE-26l @ 640 / cuda | val (114) | run_20260618_034622_b2_y_e3_yoloe_26l_val | mAP=0.179 (val). Ver combinado en B2-Y-E3-TEST. |
