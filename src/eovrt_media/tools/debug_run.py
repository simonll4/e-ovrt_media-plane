...
`RuntimeError` explícito. Su reemplazo es el split two-node dockerizado de
`infra/twonode/` (Fase 2, ya completada); la ruta local queda deshabilitada
permanentemente, sin puente hacia ese despliegue Docker.
"""
